...
async function extractAimsDataAndOpenEditor() {
  ...
  // This requires "tabs" and "credits_calculator.html" in web_accessible_resources in manifest.json
  const editorUrl = chrome.runtime.getURL("credits_calculator.html");
